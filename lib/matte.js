...
function removeBackground(buf, opts) {
  // Fast path only — AI rembg was too slow for Studio drops (David 2026-09-17).
  opts = opts || {};
  if (opts.mode === "ai" || process.env.DECOCLUB_BGCUT_MODE === "ai") {
    const ai = removeBackgroundAi(buf, "ai");
