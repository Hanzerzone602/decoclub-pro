...
const { MADEIRA_RAYON, MADEIRA_POLYNEON, nearestMadeira } = require("./madeira");
...
function listPalettes() {
  return {
    ...
    madeiraRayon: MADEIRA_RAYON.map((c) => Object.assign({}, c)),
    madeiraPolyneon: MADEIRA_POLYNEON.map((c) => Object.assign({}, c)),
