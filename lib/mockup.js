...
function artBox(kind, placement, w, h) {
  ...
  return {
    ...
    alpha: kind === "tumbler" ? 0.92 : 1,
  };
}

function renderBlank(kind, w, h, art, garment, placement) {
  ...
  const box = artBox(kind, placement, w, h);
...
function generateMockupPng(job, artworkAbs) {
  ...
  const rgba = renderBlank(kind, w, h, art, job.garment_color, job.placement);
...
module.exports = { methodFamily, generateMockupPng, generateMockupSvg, writeMockups, BLANKS };
