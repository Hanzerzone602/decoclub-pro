 ...
 *
 * Corel-equal PNG Vectorize: see rasterCorel.js hallucinate (not path-transfer).
 * Path-transfer (A) remains corel-import for Corel SVG upload only.
...
module.exports = {
  ...
  WINNER: "hallucinate-via-rasterCorel" /* path-transfer remains corel-import only */,
