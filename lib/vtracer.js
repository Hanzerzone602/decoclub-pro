...
function buildArgs(inPng, outSvg, opts) {
  ...
  /* Logo/mascot default: poster + cutout (no full-frame underpaint). */
  args.push("--preset", String(opts.preset || "poster"));
  args.push(
    "--colormode", "color",
    "--hierarchical", opts.hierarchical || "cutout",
    "--mode", "spline",
    "--filter_speckle", String(opts.filterSpeckle != null ? opts.filterSpeckle : (colors <= 4 ? 14 : colors <= 8 ? 12 : 6)),
    "--color_precision", String(opts.colorPrecision != null ? opts.colorPrecision : (colors <= 10 ? 4 : 5)),
