...
function buildArgs(inPng, outSvg, opts) {
  ...
  if (small) {
    ...
    speckle = opts.filterSpeckle != null ? opts.filterSpeckle : (colors <= 4 ? 5 : colors <= 8 ? 3 : 2);
    precision = opts.colorPrecision != null ? opts.colorPrecision : (colors <= 4 ? 6 : 7);
    corner = opts.cornerThreshold != null ? opts.cornerThreshold : 55;
...
function vectorizeBuffer(pngBuf, opts) {
  ...
  try {
    ...
    } else if (opts.softScale !== false) {
      /* Default ON — Lanczos-ish upscale for small logos (bakeoff winner). */
